    ...
    <div className="pb-24 max-w-4xl mx-auto space-y-12">
      ...
      <section className="text-center pt-8 pb-4">
        ...
        <p className="text-lg text-ink/70 font-medium max-w-2xl mx-auto">
          노션에 필요하고 내가 만들고 싶은 기능을 <br/>실제로 구현하고 검증하는 공간, '개발했슈 위젯 제빵소'를 소개합니다.
        </p>
      </section>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <section className="bg-white rounded-[32px] p-8 border border-toast-brown/20 shadow-sm">
          ...
          <ul className="space-y-4 text-ink/80 font-medium">
            <li className="flex gap-3 items-start">
              ...
              <span>"노션에 필요하고 내가 만들고 싶은 기능"을 실제로 구현하고 검증하면서 실전 경험 만들기</span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="text-forest-green mt-1">✔</span>
        ...
        <section className="bg-white rounded-[32px] p-8 border border-toast-brown/20 shadow-sm">
          ...
          <ul className="space-y-4 text-ink/80 font-medium">
            <li className="flex gap-3 items-start">
              <span className="text-forest-green mt-1">✔</span>
              <span>아이디어를 기획하고 프로토타입을 거쳐 최종 버전까지 완성·배포</span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="text-forest-green mt-1">✔</span>
              <span>빠른 피드백 루프(공유→피드백→개선) 형성 및 주 1회 꾸준한 공유</span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="text-forest-green mt-1">✔</span>
              <span>월 1회 베타테스터 피드백 2건 이상 수집해 품질 개선</span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="text-forest-green mt-1">✔</span>
              <span>프로젝트 결과물 문서화·아카이빙(재사용 가능한 자산화)</span>
            </li>
          </ul>
        </section>
      </div>
      ...
      <section className="bg-forest-green text-white rounded-[32px] p-8 md:p-10 shadow-md relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="bg-white/10 rounded-2xl p-6 mb-8 backdrop-blur-sm border border-white/20">
            <h3 className="font-bold text-lg mb-2">바이브 코딩(Vibe Coding)의 실전 적용</h3>
            <p className="text-white/90">
              바이브 코딩을 활용해 기능을 직접 기획-개발-QA까지 전 과정을 경험합니다.<br/>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <div className="text-toast-brown font-black mb-1">1~2주차</div>
                <div className="font-bold mb-2">기획 & 자료조사</div>
                <p className="text-sm text-white/70">기획서 작성<br/>레퍼런스 및 API 조사</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <div className="text-toast-brown font-black mb-1">3~5주차</div>
                <div className="font-bold mb-2">개발 진행</div>
                <p className="text-sm text-white/70">기초 위젯 제작<br/>MVP → 최종 완성/최적화</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <div className="text-toast-brown font-black mb-1">6~7주차</div>
                <div className="font-bold mb-2">피드백 수집</div>
                <p className="text-sm text-white/70">슬랙으로 요청/수집<br/>선별, 반영, 기록</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <div className="text-toast-brown font-black mb-1">8주차</div>
                <div className="font-bold mb-2">배포 & 마무리</div>
                <p className="text-sm text-white/70">배포 링크 공유<br/>GitHub / 최종 레포 정리</p>
              </div>
            </div>
          </div>
        </div>
